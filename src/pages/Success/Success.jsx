...
export default function SuccessPage () {
  ...
  useEffect(() => {
    ...
    if (saved) {
      ...
      // 🧹 очистка після збереження у state
  ...
  const total = order.totalPrice ?? subtotal + shipping;
    return (
        ...
        <div className={styles.inner}>
            <img src={groupIcon} alt="two green leaves" className={styles.icon}/>
            <h2 className={styles.title}>Your order is successfully placed ! </h2>
            <p className={styles.text}>Thanks for your order! We’re getting it ready to ship and will notify you <br/> as soon as it’s on the way.
<br/> Need help? Contact our support team anytime.</p>
            </div>

            <div className={styles.estimate}>
<div className={styles.estimateTextWrapper}>
<img src={iconBox} alt="box icon" className={styles.iconBox}></img>
...
<div className={styles.summaryTable}>
            ...
            <RelatedProducts  title="You may also love" limit={4} />
            
                <p className={styles.newsletterText}>Want more eco-friendly tips and exclusive offers? Subscribe to our Newsletter</p>
            </div>
